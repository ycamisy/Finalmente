...
<body>
    ...
    <!-- Banner Principal -->
    <section class="banner-hoteis">
        <h1>Encontre o Hotel Perfeito</h1>
        <p>Milhares de opções de hospedagem para sua viagem dos sonhos</p>
    </section>
    ...
    <section class="filtros-section">
        <div class="filtros-grid">
            ...
            <button class="btn-buscar" onclick="buscarHoteis()">Buscar Hotéis</button>
        </div>
    </section>

    <!-- Diferenciais da SkyMilles para Hotéis -->
    <section class="diferenciais-hoteis-section">
        <div class="container">
            <h2 class="section-title" id="b">Por que reservar conosco?</h2>
            <div class="diferenciais-hoteis-grid">
                <div class="diferencial-hotel-card">
                    <div class="diferencial-hotel-icon">
                        💰
                    </div>
                    <h3>Melhores Preços</h3>
                    <p>Garantimos os menores preços do mercado com price match garantido.</p>
                </div>
                ...
                <div class="diferencial-hotel-card">
                    ...
                    <p>Seus dados e transações são 100% protegidas com criptografia SSL.</p>
                </div>
                ...
                <div class="diferencial-hotel-card">
                    ...
                    <h3>Suporte 24/7</h3>
                    <p>Equipe pronta para ajudar a qualquer hora durante sua viagem.</p>
                </div>
                ...
                <div class="diferencial-hotel-card">
                    ...
                    <p>Cancele até 48h antes sem custos adicionais.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="categorias-grid">
            <div class="categoria-card" onclick="filtrarCategoria('luxo')">
                ...
                <div class="categoria-overlay">
                    ...
                    <div class="categoria-qtd">150+ hotéis</div>
                </div>
            </div>
            <div class="categoria-card" onclick="filtrarCategoria('praia')">
                ...
                <div class="categoria-overlay">
                    ...
                    <div class="categoria-qtd">280+ resorts</div>
                </div>
            </div>
            <div class="categoria-card" onclick="filtrarCategoria('negocios')">
                ...
                <div class="categoria-overlay">
                    ...
                    <div class="categoria-qtd">200+ hotéis</div>
                </div>
            </div>
            <div class="categoria-card" onclick="filtrarCategoria('familia')">
                ...
                <div class="categoria-overlay">
                    ...
                    <div class="categoria-qtd">320+ opções</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Lista de Hotéis -->
<section class="hoteis-container">
    <h2 class="section-title" id="a">Hotéis em Destaque</h2>
    <div class="hoteis-grid" id="hoteis-grid">
        ...
        <div class="hotel-card">
            ...
            <div class="hotel-content">
                ...
                <p class="hotel-location">📍 Manhattan, New York</p>
                <p class="hotel-description">Histórico hotel de luxo na 5th Avenue, em frente ao Central Park. Clássico e opulento.</p>
                <div class="hotel-amenities">
                    <span class="amenity-badge">🗽 Ponto Turístico</span>
                    <span class="amenity-badge">🍽️ Restaurante Fino</span>
                    <span class="amenity-badge">🥂 Serviço de Quarto</span>
                </div>
        ...
        <div class="hotel-card">
            ...
            <div class="hotel-content">
                <h3>Hôtel Plaza Athénée</h3>
                <p class="hotel-location">📍 Champs-Élysées, Paris</p>
                <p class="hotel-description">Endereço icônico da moda e luxo em Paris, com design clássico e vistas para a Torre Eiffel.</p>
                <div class="hotel-amenities">
                    <span class="amenity-badge">🇫🇷 Alta Costura</span>
                    <span class="amenity-badge">🧖 Spa Dior</span>
                    <span class="amenity-badge">🍷 Bar Elegante</span>
                </div>
                <div class="hotel-footer">
                    <div class="hotel-price">
                        <span class="price-label">A partir de</span>
        ...
        <div class="hotel-card">
            ...
            <div class="hotel-content">
                ...
                <p class="hotel-location">📍 Shinjuku, Tokyo</p>
                <p class="hotel-description">Famoso por sua aparição no filme "Lost in Translation", oferece vistas panorâmicas da cidade.</p>
                <div class="hotel-amenities">
                    <span class="amenity-badge">🏙️ Vista Panorâmica</span>
                    <span class="amenity-badge">🍸 New York Bar</span>
                    <span class="amenity-badge">🏊 Piscina Coberta</span>
                </div>
                <div class="hotel-footer">
                    <div class="hotel-price">
                        <span class="price-label">A partir de</span>
        ...
        <div class="hotel-card">
            ...
            <div class="hotel-content">
                ...
                <p class="hotel-location">📍 Westminster, London</p>
                <p class="hotel-description">Símbolo da elegância britânica. Famoso pelo seu serviço impecável e pelo chá da tarde.</p>
                <div class="hotel-amenities">
                    <span class="amenity-badge">👑 Realeza</span>
                    <span class="amenity-badge">☕ Chá da Tarde</span>
                    <span class="amenity-badge">🤵 Serviço Excepcional</span>
                </div>
                <div class="hotel-footer">
                    <div class="hotel-price">
                        <span class="price-label">A partir de</span>
        ...
        <div class="hotel-card">
            ...
            <div class="hotel-content">
                ...
                <p class="hotel-location">📍 Recoleta, Buenos Aires</p>
                <p class="hotel-description">Luxo tradicional no coração da Recoleta. Arquitetura Belle Époque e serviço sofisticado.</p>
                <div class="hotel-amenities">
                    <span class="amenity-badge">🇦🇷 Belle Époque</span>
                    <span class="amenity-badge">🍾 Degustação de Vinhos</span>
                    <span class="amenity-badge">💆 Spa de Luxo</span>
                </div>
                <div class="hotel-footer">
                    <div class="hotel-price">
                        <span class="price-label">A partir de</span>
        ...
        <div class="hotel-card">
            ...
            <div class="hotel-content">
                <h3>Hotel Unique</h3>
                <p class="hotel-location">📍 Ibirapuera, São Paulo</p>
                <p class="hotel-description">Design moderno e arrojado, conhecido por sua arquitetura icônica de "barco" e o bar The Skye.</p>
                <div class="hotel-amenities">
                    <span class="amenity-badge">📐 Arquitetura</span>
                    <span class="amenity-badge">🌇 Rooftop Bar</span>
                    <span class="amenity-badge">🏊 Piscina Vermelha</span>
                </div>
                <div class="hotel-footer">
                    <div class="hotel-price">
                        <span class="price-label">A partir de</span>
        ...
        <div class="hotel-card">
            ...
            <div class="hotel-content">
                ...
                <p class="hotel-location">📍 Copacabana, Rio de Janeiro</p>
                <p class="hotel-description">O hotel mais famoso do Brasil. Luxo, história e localização privilegiada na Praia de Copacabana.</p>
                <div class="hotel-amenities">
                    <span class="amenity-badge">🏖️ De Frente para o Mar</span>
                    <span class="amenity-badge">🏊 Piscina</span>
                    <span class="amenity-badge">🌟 Serviço Lendário</span>
                </div>
                <div class="hotel-footer">
                    <div class="hotel-price">
                        <span class="price-label">A partir de</span>
        ...
        <div class="hotel-card">
            ...
            <div class="hotel-content">
                <h3>Ouro Minas Palace Hotel</h3>
                <p class="hotel-location">📍 Mineirão, Belo Horizonte</p>
                <p class="hotel-description">Grande hotel para eventos e negócios em BH, com infraestrutura completa e fácil acesso.</p>
                <div class="hotel-amenities">
                    <span class="amenity-badge">⚽ Próximo ao Estádio</span>
                    <span class="amenity-badge">🎤 Centro de Convenções</span>
                    <span class="amenity-badge">🏋️ Academia</span>
                </div>
                <div class="hotel-footer">
                    <div class="hotel-price">
                        <span class="price-label">A partir de</span>
        ...
        <div class="hotel-card">
            ...
            <div class="hotel-content">
                <h3>Royal Tulip Brasília Alvorada</h3>
                <p class="hotel-location">📍 Palácio do Planalto, Brasília</p>
                <p class="hotel-description">Localizado próximo a pontos turísticos e governamentais, ideal para turismo e política.</p>
                <div class="hotel-amenities">
                    <span class="amenity-badge">🏛️ Área Política</span>
                    <span class="amenity-badge">🎾 Quadras de Tênis</span>
                    <span class="amenity-badge">⛵ Vista para o Lago</span>
                </div>
                <div class="hotel-footer">
                    <div class="hotel-price">
                        <span class="price-label">A partir de</span>
        ...
        <div class="hotel-card">
            ...
            <div class="hotel-content">
                <h3>Grand Mercure Belém</h3>
                <p class="hotel-location">📍 Estádio Mangueirão, Belém</p>
                <p class="hotel-description">Hospedagem confortável e moderna na capital do Pará, com foco em conforto executivo.</p>
                <div class="hotel-amenities">
                    <span class="amenity-badge">🌳 Próximo à Natureza</span>
                    <span class="amenity-badge">☕ Café Regional</span>
                    <span class="amenity-badge">💼 Business Center</span>
                </div>
                <div class="hotel-footer">
                    <div class="hotel-price">
                        <span class="price-label">A partir de</span>
        ...
        <div class="hotel-card">
            ...
            <div class="hotel-content">
                <h3>Hotel Jequitimar Guarujá</h3>
                <p class="hotel-location">📍 Praia do Pernambuco, Guarujá/SP</p>
                <p class="hotel-description">Resort de luxo de frente para o mar, conhecido por sua estrutura completa de lazer e spa.</p>
                <div class="hotel-amenities">
                    <span class="amenity-badge">🏝️ Resort de Praia</span>
                    <span class="amenity-badge">🧖 Spa Completo</span>
                    <span class="amenity-badge">👪 Lazer Familiar</span>
                </div>
                <div class="hotel-footer">
                    <div class="hotel-price">
                        <span class="price-label">A partir de</span>
        ...
        <div class="container">
            <div class="stats-grid">
                <div class="stat-item">
                    ...
                    <div class="stat-label">Hotéis Parceiros</div>
                </div>
                <div class="stat-item">
                    <div class="stat-number">500K+</div>
                    <div class="stat-label">Hóspedes Satisfeitos</div>
                </div>
                <div class="stat-item">
    ...
    <!-- Depoimentos -->
    <section class="depoimentos-hoteis-section">
        <div class="container">
            <h2 class="section-title" id="b">Histórias de Viagens Inesquecíveis</h2>
            <div class="depoimentos-hoteis-grid">
                <div class="depoimento-hotel-card">
                    <div class="depoimento-stars">★★★★★</div>
                    <p>"Encontrei o hotel mais lindo de Barcelona por um preço incrível! A SkyMilles tornou minha lua de mel perfeita."</p>
                    <div class="depoimento-author">
                        <img src="https://i.pravatar.cc/100?img=1" alt="Cliente">
                        <div>
                ...
                <div class="depoimento-hotel-card">
                    <div class="depoimento-stars">★★★★★</div>
                    <p>"O atendimento foi excepcional! Tive um problema na reserva e foi resolvido em minutos. Muito obrigado!"</p>
                    <div class="depoimento-author">
                ...
                <div class="depoimento-hotel-card">
                    <div class="depoimento-stars">★★★★★</div>
                    <p>"Comparei com outros sites e achei bem mais barato aqui. Voltei a usar e recomendo para todos!"</p>
                    <div class="depoimento-author">
                        <img src="https://i.pravatar.cc/100?img=5" alt="Cliente">
                        <div>
    ...
    <!-- CTA Final -->
    <section class="cta-hoteis-section">
        <div class="container">
            <h2>Pronto para sua próxima aventura?</h2>
            <p>Reserve agora e ganhe desconto de até 20% no programa de fidelidade SkyMilles</p>
            <button class="btn-cta-hoteis" onclick="document.getElementById('destino').focus()">Começar Busca</button>
        </div>
    </section>
