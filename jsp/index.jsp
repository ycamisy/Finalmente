...
<body>
    ...
    <section class="banner">
        <h1>Descubra aqui o seu próximo destino!</h1>
    ...
    <br><br>
    <h2 class="EscolhaComp">Escolha sua companhia!</h2>

    <div class="airline-selector-wrapper">
    ...
    <section class="planos-section">
        ...
        <div class="planos-container">
            ...
            <div class="plano-wrapper">
                <div class="plano-card basico">
                    <div class="plano-header">
                        <div class="plano-nome">Plano<br>Básico</div>
                        <div class="plano-preco">Apenas<br><span class="valor">R$199,99</span></div>
                    </div>
            ...
            <!-- Plano Plus (Popular e em destaque) -->
            <div class="plano-wrapper">
                <div class="plano-card plus destaque">
                    <div class="plano-header">
                        <span class="popular-badge">Popular</span>
                        <div class="plano-nome">Plano<br>Plus</div>
                        <div class="plano-preco">Apenas<br><span class="valor">R$389,99</span></div>
                    </div>
                    <div class="plano-body">
                        <ul>
                            <li>2 bagagens</li>
                            <li>Milhas acumulativas</li>
            ...
            <div class="plano-wrapper">
                <div class="plano-card premium">
                    <div class="plano-header">
                        <div class="plano-nome">Plano<br>Premium</div>
                        <div class="plano-preco">Apenas<br><span class="valor">R$749,99</span></div>
                    </div>

                    <div class="plano-body">
                        <ul >
                            <li>2 bagagens + taxa extra isentada</li>
                            <li>Milhas acumulativas + extras</li>
                            <li>Lounge VIP</li>
        ...
        <!-- Nota para mobile - aparece após todos os planos -->
        <p class="planos-nota-mobile">*Passagens não inclusas</p>
    </section>
