...
<body>
    ...
    <!-- Conteúdo Principal -->
    <main class="perguntas-main">
        <section class="perguntas-hero">
            <h1>Como Podemos Ajudar?</h1>
            <p>Tire suas dúvidas ou envie sua pergunta</p>
        </section>
        ...
        <section class="contato-section">
            <div class="contato-container">
                <div class="contato-info">
                    ...
                    <p>Não encontrou o que procurava? Envie sua dúvida e nossa equipe responderá em breve!</p>
                    
                    <div class="info-cards">
                        <div class="info-card">
                            <div class="info-icon">📧</div>
                            <h3>Email</h3>
                            <p>suporte@skymilles.com</p>
                        </div>
                        <div class="info-card">
                            <div class="info-icon">📞</div>
                            <h3>Telefone</h3>
                        ...
                        <div class="info-card">
                            <div class="info-icon">⏰</div>
                            <h3>Horário</h3>
                            <p>Seg - Sex: 8h às 20h<br>Sáb: 9h às 15h</p>
                        </div>
                    </div>
                </div>
                    ...
                    <form class="contato-form" id="contato-form">
                        ...
                        <div class="form-group-pergunta">
                            ...
                            <select id="assunto" required>
                                ...
                                <option value="pacotes">Pacotes Promocionais</option>
                                <option value="planos">Planos SkyMilles</option>
                        ...
                        <div class="form-group-pergunta">
                            ...
                            <textarea id="mensagem" required placeholder="Descreva sua dúvida ou problema..." rows="6"></textarea>
                        </div>

                        <button type="submit" class="btn-enviar">Enviar Pergunta</button>
                    </form>
                </div>
            </div>
        </section>
        ...
        <section class="faq-section">
            ...
            <p class="faq-subtitle">Confira as dúvidas mais comuns de nossos clientes</p>
            ...
            <div class="faq-container">
                <div class="faq-categoria">
                    ...
                    <div class="faq-item">
                        <button class="faq-pergunta">
                            <span>Como faço para comprar uma passagem?</span>
                            <span class="faq-icon">+</span>
                        </button>
                        <div class="faq-resposta">
                            <p>Para comprar uma passagem, basta acessar nossa página de Passagens Aéreas, preencher as informações de origem, destino, datas e número de passageiros. Em seguida, escolha entre as opções disponíveis e finalize o pagamento.</p>
                        </div>
                    </div>

                    <div class="faq-item">
                        <button class="faq-pergunta">
                            <span>Posso cancelar minha passagem?</span>
                            <span class="faq-icon">+</span>
                        </button>
                        <div class="faq-resposta">
                            <p>Sim, é possível cancelar sua passagem. As condições de cancelamento variam de acordo com a tarifa escolhida e a companhia aérea. Entre em contato com nosso suporte para mais informações sobre seu caso específico.</p>
                        </div>
                    </div>

                    <div class="faq-item">
                        <button class="faq-pergunta">
                            <span>Quanto tempo antes devo chegar ao aeroporto?</span>
                            <span class="faq-icon">+</span>
                        </button>
                        <div class="faq-resposta">
                            <p>Para voos domésticos, recomendamos chegar com 2 horas de antecedência. Para voos internacionais, o ideal é chegar com 3 horas de antecedência ao aeroporto.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="faq-categoria">
                    ...
                    <div class="faq-item">
                        <button class="faq-pergunta">
                            <span>Como funciona a reserva de hotéis?</span>
                            <span class="faq-icon">+</span>
                        </button>
                        <div class="faq-resposta">
                            <p>Acesse nossa página de Hotéis, informe o destino, datas de check-in e check-out, e número de hóspedes. Você verá todas as opções disponíveis e poderá escolher o hotel que melhor atende suas necessidades.</p>
                        </div>
                    </div>

                    <div class="faq-item">
                        <button class="faq-pergunta">
                            <span>Posso cancelar a reserva do hotel?</span>
                            <span class="faq-icon">+</span>
                        </button>
                        <div class="faq-resposta">
                            <p>As políticas de cancelamento variam de acordo com cada hotel. Alguns oferecem cancelamento gratuito até determinado prazo, enquanto outros cobram taxas. Verifique os termos antes de finalizar a reserva.</p>
                        </div>
                    </div>
                </div>

                <div class="faq-categoria">
                    <h3>Planos SkyMilles</h3>
                    <div class="faq-item">
                        <button class="faq-pergunta">
                            <span>Quais os benefícios de assinar um plano?</span>
                            <span class="faq-icon">+</span>
                        </button>
                        <div class="faq-resposta">
                            <p>Nossos planos oferecem diversos benefícios como bagagem extra, embarque prioritário, acúmulo de milhas, descontos em passagens e acesso a lounges VIP (dependendo do plano escolhido).</p>
                        </div>
                    </div>
                    ...
                    <div class="faq-item">
                        ...
                        <div class="faq-resposta">
                            <p>Sim! Você pode fazer upgrade ou downgrade do seu plano a qualquer momento. A mudança será efetivada no próximo ciclo de cobrança.</p>
                        </div>
                    </div>
                </div>

                <div class="faq-categoria">
                    <h3>Pagamento e Segurança</h3>
                    <div class="faq-item">
                        <button class="faq-pergunta">
                        ...
                        <div class="faq-resposta">
                            <p>Aceitamos cartões de crédito (Visa, Mastercard), PIX e boleto bancário. O pagamento é processado de forma segura através de nossos parceiros certificados.</p>
                        </div>
                    </div>
                    ...
                    <div class="faq-item">
                        ...
                        <div class="faq-resposta">
                            <p>Sim! Utilizamos tecnologia de criptografia SSL e seguimos rigorosos padrões de segurança para proteger seus dados pessoais e financeiros. Seus dados nunca são compartilhados com terceiros sem sua autorização.</p>
                        </div>
                    </div>
                </div>
            </div>
